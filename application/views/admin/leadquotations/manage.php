                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span><?php echo lang('page_leadquotations');?></span>
                            </li>
                        </ul>
                        <?php
                        if($GLOBALS['leadquotation_permission']['create']){
                        ?>
                        <div class="page-toolbar">
                            <div class="btn-group btn-group-devided pull-right">
                                ...
                                if($GLOBALS['leadquotation_permission']['create']){
                                    ?>
                                    <a href="<?php echo base_url('admin/leadquotations/quotation');?>" class="btn sbold blue btn-sm"><i class="fa fa-plus"></i> <?php echo lang('page_create_leadquotation');?></a>
                                    <?php
                                }
                                ?>
                    ...
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"><i class="fa fa-file"></i> <?php echo lang('page_manage_leadquotation');?></h3>
                    <!-- END PAGE TITLE-->
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <div class="portlet-title filterby">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-sm-3">
                                        <?php echo form_dropdown('filter_leadquotationstatus', $filter_leadquotationstatus, '', 'class="form-control select2" id="filter_leadquotationstatus" ');?>
                                        </div>
                                ...
                                <div class="portlet-body">
                                    <div class="table-container">
                                        ...
                                        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="leadquotation_datatable_ajax">
                                            <thead>
                                                <tr role="row" class="heading">
                                                    <th width="22%" class="all"> <?php echo lang('page_dt_quotationnr');?></th>
                                                    <th width="22%"> <?php echo lang('page_lead');?></th>
                                                    <th width="22%"> <?php echo lang('page_dt_responsibleuser');?></th>
                                                    <th width="11%"> <?php echo lang('page_dt_quotationstatus');?></th>
...
<script>
    var admin_url = '<?php echo base_url('admin/leadquotations/ajax');?>';
    var func_TableDatatablesAjax = 'TableCustomDatatablesAjax';
    var datatable_id = 'leadquotation_datatable_ajax';
...
jQuery("#filter_leadquotationstatus").select2({
	placeholder: "<?php echo lang('page_lb_select_a_status');?>",
	allowClear: true
});

jQuery('#filter_responsible,#filter_leadquotationstatus').change( function(){
    var admin_url = '<?php echo base_url('admin/leadquotations/ajax');?>';

    var filter_responsible = jQuery('#filter_responsible').val();
    var filter_leadquotationstatus = jQuery('#filter_leadquotationstatus').val();

    var admin_url = admin_url + '/'+ eval(filter_responsible) + '/' + eval(filter_leadquotationstatus);
