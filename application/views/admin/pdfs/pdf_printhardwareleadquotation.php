...
$obj_pdf = new pdf('printhardwareleadquotation',$data);

$title = lang('page_lb_print_hardware_leadquotation');
            ...
            $content.='<tr>';
                ...
                $content.='<td width="60%">'; // Right
                    $content.='<table border="0" cellspacing="0" cellpadding="0" style="font-size:10px;">';
                        $content.='<tr><td align="right">'.lang('page_lead').': &nbsp;</td><td>'.$quotation['leadnr_prefix'].'</td></tr>';
    ...
    $content.='<tr><td>';
        $content.='<table border="0" width="100%" cellspacing="0" cellpadding="15">';
            $content.='<tr>';
                ...
                $content.='<td width="60%">'; //Right
                    $content.='<table border="0" cellspacing="0" cellpadding="0" style="font-size:12px;">';
                        $content.='<tr><th align="right"><b>'.lang('page_dt_quotationnr').'.:</b> &nbsp;</th><th><b>'.$quotation['leadquotationnr_prefix'].'</b></th></tr>';
                        $content.='<tr><th align="right"><b>'.lang('page_fl_date').':</b> &nbsp;</th><th><b>'._d($quotation['leadquotationdate']).'</b></th></tr>';
                    $content.='</table>';
                $content.='</td>';
            $content.='</tr>';
        $content.='</table>';
...
$obj_pdf->Output('LeadHardwareQuotation-'.$data['quotation']['leadquotationnr'].'.pdf', 'I');
?>