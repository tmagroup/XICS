...
$obj_pdf = new pdf('printconsultationprotocol',$data);
extract($data);
...
$content = '<table border="0" width="100%" cellspacing="0" cellpadding="0" style="color:#2b2b2a">';
            ...
            $content.='<tr>';
                ...
                $content.='<td width="50%">'; // Right
                    $content.='<table border="0" width="100%" cellspacing="0" cellpadding="0" style="font-size:10px;">';
                        $content.='<tr><td align="right" width="30%">'.lang('page_dt_customernr').': &nbsp;</td><td width="70%">'.$quotation['customernr_prefix'].'</td></tr>';
    ...
    $content.='<tr><td>';
        $content.='<table border="0" width="100%" cellspacing="0" cellpadding="0">';
            $content.='<tr>';
                $content.='<td width="50%">'; //Left
                    $content.='<table border="0" width="80%" cellspacing="0" cellpadding="4" style="font-size:12px;">';
                        $content.='<tr><td><b>'.lang('page_consultation_quotation_pdf_generaladvice').'</b></td></tr>';
                        $content.='<tr><td style="border-bottom:0px solid #000; font-size:10px;">'.lang('page_fl_date').': </td></tr>';
                        $content.='<tr><td style="border-bottom:0px solid #000; font-size:10px;">'.lang('page_consultation_quotation_pdf_companycity').': <span style="color:#ff0000;">'.$quotation['customer_city'].'</span></td></tr>';
                    $content.='</table>';
                $content.='</td>';
                $content.='<td width="50%">'; // Right
                    $content.='<table border="0" width="80%" cellspacing="0" cellpadding="4" style="font-size:12px;">';
                        $content.='<tr><td><b>'.lang('page_consultation_quotation_pdf_otherpersonpresent').'</b></td></tr>';
                        $content.='<tr><td style="border-bottom:0px solid #000; font-size:10px;"></td></tr>';
                        $content.='<tr><td style="border-bottom:0px solid #000; font-size:10px;"></td></tr>';
                    $content.='</table>';
                $content.='</td>';
            $content.='</tr>';
        ...
        $content.='<table border="0" width="100%" cellspacing="0" cellpadding="0">';
            $content.='<tr>';
                $content.='<td width="40%">'; //Left
                    $content.='<table border="0" width="95%" cellspacing="0" cellpadding="4" style="font-size:12px;">';
                        $content.='<tr><td style="border-bottom:0px solid #000; font-size:10px;">'.lang('page_fl_company').': <span style="color:#ff0000;">'.$quotation['customer_company'].'</span></td></tr>';
                        $content.='<tr><td style="border-bottom:0px solid #000; font-size:10px;">'.lang('page_fl_street').': <span style="color:#ff0000;">'.$quotation['customer_street'].'</span></td></tr>';
                        $content.='<tr><td style="border-bottom:0px solid #000; font-size:10px;">'.lang('page_fl_position').': <span style="color:#ff0000;">'.$quotation['customer_position'].'</span></td></tr>';
                    $content.='</table>';
                $content.='</td>';
                $content.='<td width="60%">'; // Right
                    $content.='<table border="0" width="84%" cellspacing="0" cellpadding="4" style="font-size:12px;">';
                        $content.='<tr><td style="border-bottom:0px solid #000; font-size:10px;">'.lang('page_fl_contactperson').': <span style="color:#ff0000;">'.$quotation['customer_contact_person'].'</span></td></tr>';
                        $content.='<tr><td style="border-bottom:0px solid #000; font-size:10px;">'.lang('page_fl_zipcode').'/'.lang('page_fl_city').': <span style="color:#ff0000;">'.$quotation['customer_zipcode'].' '.$quotation['customer_city'].'</span></td></tr>';
                        $content.='<tr><td style="border-bottom:0px solid #000; font-size:10px;">'.lang('page_consultation_quotation_pdf_customerdirector').': <span style="color:#ff0000;">'.$quotation['customer_name'].'</span></td></tr>';
                    $content.='</table>';
                $content.='</td>';
            $content.='</tr>';
        $content.='</table>';
            ...
            $content.='<tr>';
                $content.='<td width="100%">'; //Left
                    $content.='<table border="0" width="90%" cellspacing="0" cellpadding="0" style="font-size:12px;">';
                        ...
                        if ($data['quotation']['customerrequirements']) {
                            $content.='<tr><td width="100%" style="font-size:8px;">'.nl2br($data['quotation']['customerrequirements']).'</td></tr>';
                        }
                        $content.='<tr><td width="100%" style="border-bottom:0px solid #000;"></td></tr>';
                        $content.='<tr><td width="100%" style="border-bottom:0px solid #000;"></td></tr>';
    ...
    $content.='<tr><td>';
        $content.='<table border="0" width="100%" cellspacing="0" cellpadding="0">';
            $content.='<tr>';
                $content.='<td width="100%">'; //Left
                    $content.='<table border="0" width="90%" cellspacing="0" cellpadding="0" style="font-size:12px;">';
                        $content.='<tr><td width="100%"><b>'.lang('page_consultation_quotation_pdf_recommendations').'</b></td></tr>';
                        $content.='<tr><td width="100%" style="border-bottom:0px solid #000;"></td></tr>';
                        $content.='<tr><td width="100%" style="border-bottom:0px solid #000;"></td></tr>';
                        $content.='<tr><td width="100%" style="border-bottom:0px solid #000;"></td></tr>';
                    $content.='</table>';
...
$obj_pdf->Output('QuotationConsultationProtocol-'.$data['quotation']['quotationnr'].'.pdf', 'I');
?>