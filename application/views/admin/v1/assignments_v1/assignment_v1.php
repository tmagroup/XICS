                                                        ...
                                                        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%">    
                                                            <thead>
                                                                <tr role="row" class="heading">                                                                                                        
                                                                    ...
                                                                    <th class="text-nowrap"><?php echo lang('page_fl_employee');?> <span class="required"> * </span></th>
                                                                    ...
                                                                    <th class="text-nowrap"><?php echo lang('page_fl_optiontitle');?> <span class="required"> * </span></th>
                                                                    <th class="text-nowrap"><?php echo lang('page_fl_value');?> <span class="required"> * </span></th>                                                    
                                                            ...
                                                            if(isset($assignmentproducts) && count($assignmentproducts)>0){
                                                                ...
                                                                foreach($assignmentproducts as $pkey=>$assignmentproduct){
                                                                    ...
                                                                    <tr id="row1_old_assignmentproduct_<?php echo $assignmentproduct['id'];?>">
                                                                        ...
                                                                        <td><?php echo form_input('employee['.$pkey.']', $assignmentproduct['employee'], 'class="form-control"');?></td>
                                                                        ...
                                                                        <td id="old_newoptionmobile_box_<?php echo $assignmentproduct['id'];?>"><?php if($formula=='A'){ echo form_dropdown('newoptionmobile['.$pkey.']', $mobileoptions, $assignmentproduct['newoptionmobile'], 'class="form-control newoptionmobile" id="old_newoptionmobile_'.$pkey.'" datarow="'.$pkey.'" datatype="old" '); }else{
                                                                            echo form_input('newoptionmobile['.$pkey.']', $assignmentproduct['newoptionmobile'], 'class="form-control" id="old_newoptionmobile_'.$pkey.'" ');
                                                                        }?></td>
                                                                        <td><?php echo form_input('value4['.$pkey.']', $assignmentproduct['value4'], 'class="form-control" id="old_value4_'.$pkey.'" ');?></td>
                                                                        <td><?php 
                                                                        if($assignmentproduct['hardwarecheck']==1){
                                                                            echo form_dropdown('hardware['.$pkey.']', $hardwares, $assignmentproduct['hardware'], 'class="form-control assignment_hardware" datarow="'.$pkey.'" id="old_hardware_'.$pkey.'" disabled ');
                                                                            
                                                                            $data_hidden = array('type'=>'hidden', 'name'=>'hardware['.$pkey.']', 'value'=>$assignmentproduct['hardware']);  
                                                                            echo form_input($data_hidden);
                                                                        }
                                                                        else{
                                                                            echo form_dropdown('hardware['.$pkey.']', $hardwares, $assignmentproduct['hardware'], 'class="form-control assignment_hardware" datarow="'.$pkey.'" id="old_hardware_'.$pkey.'" ');
                                                                        }
                                                                        ?></td>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            if(!$finished){
                                                                                ...
                                                                                <div id="old_form_date_<?php echo $pkey;?>" class="input-group date form_date">
                                                                                    <?php $dd = array('name'=>'endofcontract['.$pkey.']', 'class'=>'form-control', 'readonly'=>true, 'size'=>16, 'value'=> _d($assignmentproduct['endofcontract']));
                                                                                    echo form_input($dd);?>  
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo form_input('employee[0]', isset($assignment['employee'][0])?$assignment['employee'][0]:'', 'class="form-control"  ');?></td>
                                                                    ...
                                                                    <td id="new_newoptionmobile_box_0"><?php if($formula=='A'){ echo form_dropdown('newoptionmobile[0]', $mobileoptions, isset($assignment['newoptionmobile'][0])?$assignment['newoptionmobile'][0]:'', 'class="form-control newoptionmobile" id="new_newoptionmobile_0" datarow="0" datatype="new" '); }else{
                                                                        echo form_input('newoptionmobile[0]', isset($assignment['newoptionmobile'][0])?$assignment['newoptionmobile'][0]:'', 'class="form-control" id="new_newoptionmobile_0"  ');
                                                                    }?></td>
                                                                    <td><?php echo form_input('value4[0]', isset($assignment['value4'][0])?$assignment['value4'][0]:'', 'class="form-control" id="new_value4_0"  ');?></td>
                                                                    <td><?php echo form_dropdown('hardware[0]', $hardwares, isset($assignment['hardware'][0])?$assignment['hardware'][0]:'', 'class="form-control assignment_hardware" datarow="0" ');?></td>
                                                                    ...
                                                                    <td>
                                                                        <div id="new_form_date_0" class="input-group date form_date">
                                                                            <?php $dd = array('name'=>'endofcontract[0]', 'class'=>'form-control', 'readonly'=>true, 'size'=>16, 'value'=> isset($assignment['endofcontract'][0])?$assignment['endofcontract'][0]:'');
                                                                            echo form_input($dd);?>  
                                                                ...
                                                                if(isset($assignment['mobilenr']) && count($assignment['mobilenr'])>0){
                                                                    foreach($assignment['mobilenr'] as $pkey=>$assignmentproduct){
                                                                        ...
                                                                        <tr id="row1_new_assignmentproduct_<?php echo $pkey;?>">
                                                                            ...
                                                                            <td><?php echo form_input('employee['.$pkey.']', isset($assignment['employee'][$pkey])?$assignment['employee'][$pkey]:'', 'class="form-control"  ');?></td>
                                                                            ...
                                                                            <td id="new_newoptionmobile_box_<?php echo $pkey;?>"><?php if($formula=='A'){ echo form_dropdown('newoptionmobile['.$pkey.']', $mobileoptions, isset($assignment['newoptionmobile'][$pkey])?$assignment['newoptionmobile'][$pkey]:'', 'class="form-control newoptionmobile" id="new_newoptionmobile_'.$pkey.'" datarow="'.$pkey.'" datatype="new"  '); }else{
                                                                                echo form_input('newoptionmobile['.$pkey.']', isset($assignment['newoptionmobile'][$pkey])?$assignment['newoptionmobile'][$pkey]:'', 'class="form-control" id="new_newoptionmobile_'.$pkey.'"  ');
                                                                            }?></td>
                                                                            <td><?php echo form_input('value4['.$pkey.']', isset($assignment['value4'][$pkey])?$assignment['value4'][$pkey]:'', 'class="form-control" id="new_value4_'.$pkey.'"  ');?></td>
                                                                            <td><?php echo form_dropdown('hardware['.$pkey.']', $hardwares, isset($assignment['hardware'][$pkey])?$assignment['hardware'][$pkey]:'', 'class="form-control assignment_hardware" datarow="'.$pkey.'" ');?></td>
                                                                            ...
                                                                            <td>
                                                                                <div id="new_form_date_<?php echo $pkey;?>" class="input-group date form_date">
                                                                                    <?php $dd = array('name'=>'endofcontract['.$pkey.']', 'class'=>'form-control', 'readonly'=>true, 'size'=>16, 'value'=> isset($assignment['endofcontract'][$pkey])?$assignment['endofcontract'][$pkey]:'');
                                                                                    echo form_input($dd);?>  
...
jQuery('.addassignmentproduct').click( function(){    
    ...
    inputhtml = inputhtml + '<td><input type="text" name="employee['+rownum+']" value=""  class="form-control" /></td>';
    ...
    inputhtml = inputhtml + '<td id="new_newoptionmobile_box_'+rownum+'"><select name="newoptionmobile['+rownum+']" class="form-control newoptionmobile" id="new_newoptionmobile_'+rownum+'" datarow="'+rownum+'" datatype="new" >';
    <?php
    ...
    ?>
    inputhtml = inputhtml + '</select></td>';       
    inputhtml = inputhtml + '<td><input type="text" name="value4['+rownum+']" value=""  class="form-control" id="new_value4_'+rownum+'" /></td>';
    inputhtml = inputhtml + '<td><select name="hardware['+rownum+']" class="form-control assignment_hardware" datarow="'+rownum+'">';
    <?php
    ...
    inputhtml = inputhtml + '<td><div id="new_form_date_'+rownum+'" class="input-group date form_date"><input type="text" name="endofcontract['+rownum+']" value="" class="form-control" readonly="1" size="16" >';
...
function changeFormula(){
    jQuery('.formula').change( function(){   
        ...
        if(formula=='A'){
            ...
            //New Option Mobile
            selecthtml ='<select name="newoptionmobile['+rown+']" class="form-control newoptionmobile" id="'+rowt+'_newoptionmobile_'+rown+'" datarow="'+rown+'" datatype="'+rowt+'" >';
            <?php
            foreach($mobileoptions as $k=>$v){
                ?>               
                selecthtml = selecthtml + "<option value='<?php echo $k;?>'><?php echo $v;?></option>";
            ...
            //New Option Mobile
            jQuery('#'+rowt+'_newoptionmobile_box_'+rown).html('<input type="text" name="newoptionmobile['+rown+']" class="form-control" id="'+rowt+'_newoptionmobile_'+rown+'">');
