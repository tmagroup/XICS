...
foreach($legitimations as $legitimation) {
    ...
    $data .= '<a href="javascript:void(0);" class="text-danger" onclick="deleteConfirmation(\''.base_url("admin/assignments/deleteLegitimation").'\',\''.$legitimation['id'].'\',\''.lang("page_lb_delete_assignmentlegitimation").'\',\''.lang("page_lb_delete_assignmentlegitimation_info").'\',\'true\');"><i class="fa fa fa-times"></i></a>';
    }
    $data .= '</div>';
