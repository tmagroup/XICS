                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php echo form_dropdown('hardwareassignmentstatus', $hardwareassignmentstatus, isset($hardwareassignment['hardwareassignmentstatus'])?$hardwareassignment['hardwareassignmentstatus']:'', 'class="form-control" '.$field_hardwareassignmentstatus_disabled);?>
                                                </div>
                                                                ...
                                                                if(isset($hardwareassignmentproducts) && count($hardwareassignmentproducts)>0){
                                                                    ...
                                                                    foreach($hardwareassignmentproducts as $pkey=>$hardwareassignmentproduct){                                                                
                                                                        ...
                                                                        <tr id="row1_old_hardwareassignment_<?php echo $hardwareassignmentproduct['id'];?>">
                                                                            ...
                                                                            <td><?php echo form_input('simnr['.$pkey.']', $hardwareassignmentproduct['simnr'], 'class="form-control" '.$field_simnr_disabled);?></td>
                                                                            ...
                                                                            <td><?php echo form_dropdown('hardware['.$pkey.']', $hardwares, $hardwareassignmentproduct['hardware'], 'class="form-control hardware" id="old_hardware_'.$pkey.'" datarow="'.$pkey.'" datatype="old" '.$field_hardware_disabled);?></td>
...
jQuery('.hardware').change(function(e) {
    ...
    jQuery.ajax({dataType: "JSON", url: '<?php echo base_url('admin/hardwareassignments/getStockHardwares/');?>'+hardware, success: function(data){
...
jQuery('.stockhardware').change(function(e) {
    var stockhardware = jQuery(this).val();
    var rown = jQuery(this).attr('datarow');
    var rowt = jQuery(this).attr('datatype');
    
    jQuery("#"+rowt+"_seriesnr_"+rown).val("");
    
    jQuery.ajax({url: '<?php echo base_url('admin/hardwareassignments/getStockHardwareSeriesnr/');?>'+eval(stockhardware), success: function(data){
         jQuery("#"+rowt+"_seriesnr_"+rown).val(data);
    }});
});
</script>
