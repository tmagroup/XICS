                                                    ...
                                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%">    
                                                        ...
                                                        if(isset($quotationproducts) && count($quotationproducts)>0){
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="input-group date form_date">
                                                                        <?php $dd = array('name'=>'endofcontract[0]', 'class'=>'form-control noerror', 'readonly'=>true, 'size'=>16, 'value'=> isset($quotation['endofcontract'][0])?$quotation['endofcontract'][0]:'');
                                                                        echo form_input($dd);?>  
...
jQuery('.addquotationproduct').click( function(){    
    ...
    inputhtml = inputhtml + '<td><div class="input-group date form_date"><input type="text" name="endofcontract['+rownum+']" value="" class="form-control noerror" readonly="1" size="16" >';
