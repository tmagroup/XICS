                                                        ...
                                                        if(isset($quotationproducts) && count($quotationproducts)>0){
                                                            ...
                                                            foreach($quotationproducts as $pkey=>$quotationproduct){
                                                                ...
                                                                <tr id="row2_old_quotationproduct_<?php echo $quotationproduct['id'];?>">
                                                                    ...
                                                                    <td></td>
                                                                    <td id="old_newoptionmobile_box_<?php echo $pkey;?>"><?php if($formula=='A'){ echo form_dropdown('newoptionmobile['.$pkey.']', $mobileoptions, $quotationproduct['newoptionmobile'], 'class="form-control newoptionmobile" id="old_newoptionmobile_'.$pkey.'" datarow="'.$pkey.'" datatype="old" '); }else{
                                                                        echo form_input('newoptionmobile['.$pkey.']', $quotationproduct['newoptionmobile'], 'class="form-control" id="old_newoptionmobile_'.$pkey.'" ');
                                                                    }?></td>
                                                                    <td><?php echo form_input('value4['.$pkey.']', $quotationproduct['value4'], 'class="form-control" id="old_value4_'.$pkey.'" ');?></td>
                                                                    <td colspan="2">                                                                        
                                                                        <?php
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td></td>
                                                                <td id="new_newoptionmobile_box_0"><?php if($formula=='A'){ echo form_dropdown('newoptionmobile[0]', $mobileoptions, isset($quotation['newoptionmobile'][0])?$quotation['newoptionmobile'][0]:'', 'class="form-control newoptionmobile" id="new_newoptionmobile_0" datarow="0" datatype="new" '); }else{
                                                                    echo form_input('newoptionmobile[0]', isset($quotation['newoptionmobile'][0])?$quotation['newoptionmobile'][0]:'', 'class="form-control" id="new_newoptionmobile_0"  ');
                                                                }?></td>
                                                                <td><?php echo form_input('value4[0]', isset($quotation['value4'][0])?$quotation['value4'][0]:'', 'class="form-control" id="new_value4_0"  ');?></td>
                                                                <td colspan="2">
                                                                    <?php
                                                            ...
                                                            if(isset($quotation['mobilenr']) && count($quotation['mobilenr'])>0){
                                                                foreach($quotation['mobilenr'] as $pkey=>$quotationproduct){
                                                                    ...
                                                                    <tr id="row2_new_quotationproduct_<?php echo $pkey;?>">
                                                                        ...
                                                                        <td></td>
                                                                        <td id="new_newoptionmobile_box_<?php echo $pkey;?>"><?php if($formula=='A'){ echo form_dropdown('newoptionmobile['.$pkey.']', $mobileoptions, isset($quotation['newoptionmobile'][$pkey])?$quotation['newoptionmobile'][$pkey]:'', 'class="form-control newoptionmobile" id="new_newoptionmobile_'.$pkey.'" datarow="'.$pkey.'" datatype="new"  '); }else{
                                                                            echo form_input('newoptionmobile['.$pkey.']', isset($quotation['newoptionmobile'][$pkey])?$quotation['newoptionmobile'][$pkey]:'', 'class="form-control" id="new_newoptionmobile_'.$pkey.'"  ');
                                                                        }?></td>
                                                                        <td><?php echo form_input('value4['.$pkey.']', isset($quotation['value4'][$pkey])?$quotation['value4'][$pkey]:'', 'class="form-control" id="new_value4_'.$pkey.'"  ');?></td>
                                                                        <td colspan="2">
                                                                            <?php
