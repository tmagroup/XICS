<div class="portlet-title">
    ...
    <?php
    if($GLOBALS['todocomment_permission']['create']){
        ?>
        <div class="actions">
...
if($GLOBALS['todocomment_permission']['create']){
    ?>
    <?php echo form_open(base_url('admin/todos/addComment'),array("id"=>"addCommentAjax")); ?>        
        <div id="addcommentbox">
            <?php echo form_hidden('rel_id',$todo['todonr']);?>
            <?php echo form_hidden('rel_type','todo');?>
            <?php echo form_hidden('addedto',$todo['responsible_id']);?>
                ...
                <li class="<?php if($comment['addedfrom']==get_user_id()){ echo "out"; }else{ echo "in"; }?>">
                    ...
                    <div class="message">
                        ...
                        <span class="body"> <?php echo $comment['description'];?> 
                            ...
                            <?php
                            if($GLOBALS['todocomment_permission']['delete']){
                                ?>
                                <div class="text-<?php if($comment['addedfrom']==get_user_id()){ echo "right"; }else{ echo "left"; }?>">
                                    <a href="javascript:void(0);" class="text-danger" onclick="deleteConfirmation('<?php echo base_url("admin/todos/deleteComment");?>','<?php echo $comment['id'];?>','<?php echo lang("page_lb_delete_todocomment");?>','<?php echo lang("page_lb_delete_todocomment_info");?>','true','<?php echo $comment['rel_id'];?>');"><i class="fa fa fa-times"></i></a>
                                </div>
                                <?php
                            }
                            ?>
