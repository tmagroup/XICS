                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span>
                                    <?php
                                    echo lang('page_import_ratelandline'); 
                                    ?>
                                </span>
                            </li>
                        ...
                        <div class="page-toolbar">
                            <div class="btn-group btn-group-devided pull-right">  
                                <?php echo form_open($this->uri->uri_string(), array('enctype' => "multipart/form-data", 'id' => 'form_ratelandline1') );?>
                    ...
                    <div class="m-heading-1 border-blue m-bordered">
                        <ul>
                            ...
                            <li class="text-danger"><?php echo sprintf(lang('import_note3'),lang('page_fl_ratetitle'));?></li>
                        </ul>
                    </div>
                                    ...
                                    <thead>
                                        ...
                                        <?php
                                            ...
                                            foreach($db_fields as $field){
                                                ...
                                                ?>
                                                <th class="bold <?php if($field == 'ratenr' || $field == 'ratetitle'){ echo "text-danger"; }?>"><?php echo ucfirst($field);?></th>
                                                <?php 
                                                $total_fields++;
                                            } 
                                        ?>
