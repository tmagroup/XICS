...
if($GLOBALS['quotationcomment_permission']['create']){
    ?>
    <?php echo form_open(base_url('admin/quotations/addComment'),array("id"=>"addCommentAjax")); ?>        
                        ...
                        <span class="body"> <?php echo $comment['description'];?> 
                            ...
                            if($GLOBALS['quotationcomment_permission']['delete']){
                                ...
                                <div class="text-<?php if($comment['addedfrom']==get_user_id()){ echo "right"; }else{ echo "left"; }?>">
                                    <a href="javascript:void(0);" class="text-danger" onclick="deleteConfirmation('<?php echo base_url("admin/quotations/deleteComment");?>','<?php echo $comment['id'];?>','<?php echo lang("page_lb_delete_quotationcomment");?>','<?php echo lang("page_lb_delete_quotationcomment_info");?>','true','<?php echo $comment['rel_id'];?>');"><i class="fa fa fa-times"></i></a>
                                </div>
                                <?php
                            }
                            ?>
