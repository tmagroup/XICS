...
<body>
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-12">
				<p class="text-center" style="font-size: 12px;color: #000000;font-family: Arial;margin-bottom: 2px !important;"><?php echo lang('page_fl_app_cancel_message_line1');?></p>
				<p class="text-center" style="font-size: 12px;color: #000000;font-family: Arial;margin-bottom: 2px !important;"><?php echo lang('page_fl_app_cancel_message_line2');?></p><br>
				<p class="text-center" style="font-size: 12px;color: #000000;font-family: Arial;margin-bottom: 2px !important;font-weight: bold;"><?php echo lang('page_fl_app_cancel_message_line3');?></p><br>
			</div>
			<div class="col-md-12">
				<p class="text-center"><a href="<?php echo base_url().'cronjobs/terminationAcceptCancel/'.md5($terminationData['id']).'/accept/';?>" class="btn btn-lg- btn-default" style="width: 185px;height: 33px;background-color: #e30613;border: 1px solid #111111;font-size: 18px;color: #ffffff;font-weight: bold;font-family:Arial"><?php echo lang('page_fl_accept');?></a></p>
			</div>
			<div class="col-md-12">
