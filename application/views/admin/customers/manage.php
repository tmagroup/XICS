            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        ...
                        <?php
                        if($GLOBALS['customer_permission']['create']){
                        ?>
                        <div class="page-toolbar">
                            <div class="btn-group pull-right">
                                <a href="<?php echo base_url('admin/customers/customer');?>" class="btn sbold blue btn-sm"><i class="fa fa-plus"></i> <?php echo lang('page_create_customer');?></a>
                            </div>
                        </div>
                        <?php
                        }
...
<script>
    var admin_url = '<?php echo base_url('admin/customers/ajax');?>';
    ...
    var datatable_columnDefs = 10;
    var datatable_columnDefs2 = 10;
    var datatable_sortColumn = 1;
    var datatable_sortColumnBy = 'desc';
    var datatable_hide_columns = 11;
</script>
