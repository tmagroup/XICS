<div class="portlet-title">
    ...
    <?php
    if($GLOBALS['monitoringcomment_permission']['create']){
        ?>
        <div class="actions">
...
if($GLOBALS['monitoringcomment_permission']['create']){
    ?>
    <?php echo form_open(base_url('admin/monitorings/addComment'),array("id"=>"addCommentAjax")); ?>        
        <div id="addcommentbox">
            <?php echo form_hidden('rel_id',$monitoring['monitoringnr']);?>
            <?php echo form_hidden('rel_type','monitoring');?>
            <?php echo form_hidden('addedto',$monitoring['responsible_id']);?>
                ...
                <li class="<?php if($comment['addedfrom']==get_user_id()){ echo "out"; }else{ echo "in"; }?>">
                    ...
                    <div class="message">
                        ...
                        <span class="body"> <?php echo $comment['description'];?> 
                            ...
                            <?php
                            if($GLOBALS['monitoringcomment_permission']['delete']){
                                ?>
                                <div class="text-<?php if($comment['addedfrom']==get_user_id()){ echo "right"; }else{ echo "left"; }?>">
                                    <a href="javascript:void(0);" class="text-danger" onclick="deleteConfirmation('<?php echo base_url("admin/monitorings/deleteComment");?>','<?php echo $comment['id'];?>','<?php echo lang("page_lb_delete_monitoringcomment");?>','<?php echo lang("page_lb_delete_monitoringcomment_info");?>','true','<?php echo $comment['rel_id'];?>');"><i class="fa fa fa-times"></i></a>
                                </div>
                                <?php
                            }
                            ?>
