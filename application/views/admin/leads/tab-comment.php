<div class="portlet-title">
    ...
    <?php
    if($GLOBALS['leadcomment_permission']['create']){
        ?>
        <div class="actions">
...
if($GLOBALS['leadcomment_permission']['create']){
    ?>
    <?php echo form_open(base_url('admin/leads/addComment'),array("id"=>"addCommentAjax")); ?>        
        <div id="addcommentbox">
            <?php echo form_hidden('rel_id',$lead['leadnr']);?>
            <?php echo form_hidden('rel_type','lead');?>
            <?php echo form_hidden('addedto',$lead['responsible_id']);?>
