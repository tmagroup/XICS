...
<div class="portlet light portlet-fit portlet-datatable bordered">                                
    <div class="portlet-body form">
        ...
        <div class="col-md-12">
            <a href="javascript:void(0);" onclick="addeditReminderAjax('<?php echo base_url('admin/reminders/addReminder');?>','','<?php echo sprintf(lang('page_create_reminder'),lang('page_lead'));?>');" class="btn sbold blue btn-sm"><i class="fa fa-bell-o"></i> <?php echo sprintf(lang('page_create_reminder'),lang('page_lead'));?></a>
        </div>    
...
<script>
    var admin_url = '<?php echo base_url('admin/reminders/ajax/'.$lead['leadnr'].'/lead');?>';    
