    ...
    <div class="portlet-body form">
        ...
        <div class="form-body">
            ...
            <div class="col-md-12">
                ...
                <form action="<?php echo base_url('admin/leads/uploadDocuments/'.$lead['leadnr']);?>" class="dropzone dropzone-file-area" id="my-dropzone" style="padding-top:40px;"></form>
                <div class="clearfix">&nbsp;</div>
                
                <div id="lead_attachments">
...
<script>
    var admin_url_2 = '<?php echo base_url('admin/leads/ajaxdocument/'.$lead['leadnr']);?>';    
