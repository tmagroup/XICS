<?php     
    ...
    $aColumns = array(
        ...
        'hardwareassignmentnr_prefix',
        'tblhardwareassignments.company as company',
    ...
    //$where = do_action('hardwareassignments_table_sql_where', array());    
        ...
        $where = array();
        array_push($where, "AND tblhardwareassignments.customer='".$customer_id."'");    
    ...
    foreach ($rResult as $aRow) {
        ...
        $aRow['hardwareassignmentnr_prefix'] = '<a href="javascript:void(0);" onclick="FormAjax(\''.base_url('admin/customers/getHardwareAssignmentDetail/'.$aRow['hardwareassignmentnr']).'\',\''.lang('page_detail_hardwareassignment').'\');">'.$aRow['hardwareassignmentnr_prefix'].'</a>';
