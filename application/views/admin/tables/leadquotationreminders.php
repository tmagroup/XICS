<?php
    ...
    $sTable        = 'tblleadquotationreminders';
    $join = array('LEFT JOIN tblremindersubjects ON tblremindersubjects.id=tblleadquotationreminders.remindersubject');

    //$where = do_action('reminders_table_sql_where', array());
    $where = array();
    array_push($where, "AND tblleadquotationreminders.rel_id='".$rel_id."' AND tblleadquotationreminders.rel_type='".$rel_type."'");
    ...
    foreach ($rResult as $aRow) {
        ...
        . '\''.base_url("admin/leadquotationreminders/editReminder").'\','
        . '\''.$aRow["remindernr"].'\','
        ...
        . '\''.base_url("admin/leadquotationreminders/deleteReminder").'\','
        . '\''.$aRow["remindernr"].'\','
