<?php     
    ...
    $sTable        = 'tblhardwareassignmentreminders';
    $join = array('LEFT JOIN tblremindersubjects ON tblremindersubjects.id=tblhardwareassignmentreminders.remindersubject');
    
    //$where = do_action('reminders_table_sql_where', array());    
    $where = array(); 
    array_push($where, "AND tblhardwareassignmentreminders.rel_id='".$rel_id."' AND tblhardwareassignmentreminders.rel_type='".$rel_type."'");
    ...
    foreach ($rResult as $aRow) {
        ...
        . '\''.base_url("admin/hardwareassignmentreminders/editReminder").'\','
        . '\''.$aRow["remindernr"].'\','       
        ...
        . '\''.base_url("admin/hardwareassignmentreminders/deleteReminder").'\','
        . '\''.$aRow["remindernr"].'\','
