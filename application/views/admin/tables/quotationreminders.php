<?php     
    ...
    $sTable        = 'tblquotationreminders';
    $join = array('LEFT JOIN tblremindersubjects ON tblremindersubjects.id=tblquotationreminders.remindersubject');
    
    //$where = do_action('reminders_table_sql_where', array());    
    $where = array(); 
    array_push($where, "AND tblquotationreminders.rel_id='".$rel_id."' AND tblquotationreminders.rel_type='".$rel_type."'");
    ...
    foreach ($rResult as $aRow) {
        ...
        . '\''.base_url("admin/quotationreminders/editReminder").'\','
        . '\''.$aRow["remindernr"].'\','       
        ...
        . '\''.base_url("admin/quotationreminders/deleteReminder").'\','
        . '\''.$aRow["remindernr"].'\','
