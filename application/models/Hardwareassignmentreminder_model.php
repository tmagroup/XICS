...
class Hardwareassignmentreminder_model extends CI_Model
{
    var $table = 'tblhardwareassignmentreminders';
    var $aid = 'remindernr';
    ...
    {    
        ...
        if($id>0){            
            //Add ID Prefix
            $dataId = array();
            $dataId['remindernr_prefix'] = idprefix('hardwareassignmentreminder',$id);
            ...
            logActivity('New Hardware Assignment Reminder Added [ID: ' . $id . ', Subject: ' . $name . ']');         
        }
    ...
    {    
        ...
        if ($this->db->affected_rows() > 0) {            
            ...
            //Log Activity
            $name = isset($rowfield->name)?$rowfield->name:'';
            logActivity('Hardware Assignment Reminder Updated [ID: ' . $id . ', Subject: ' . $name . ']');
        } 
    ...
    public function delete($id)
    {
        ...
        //Log Activity
	$name = isset($rowfield->name)?$rowfield->name:'';
        logActivity('Hardware Assignment Reminder Deleted [ID: ' . $id . ', Subject: ' . $name . ']');
