...
class Assignmentreminder_model extends CI_Model
{
    var $table = 'tblassignmentreminders';
    var $aid = 'remindernr';
    ...
    {    
        ...
        if($id>0){            
            //Add ID Prefix
            $dataId = array();
            $dataId['remindernr_prefix'] = idprefix('assignmentreminder',$id);
            ...
            logActivity('New Assignment Reminder Added [ID: ' . $id . ', Subject: ' . $name . ']');         
        }
    ...
    {    
        ...
        if ($this->db->affected_rows() > 0) {            
            ...
            //Log Activity
            $name = isset($rowfield->name)?$rowfield->name:'';
            logActivity('Assignment Reminder Updated [ID: ' . $id . ', Subject: ' . $name . ']');
        } 
    ...
    public function delete($id)
    {
        ...
        //Log Activity
	$name = isset($rowfield->name)?$rowfield->name:'';
        logActivity('Assignment Reminder Deleted [ID: ' . $id . ', Subject: ' . $name . ']');
