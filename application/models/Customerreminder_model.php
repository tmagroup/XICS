...
class Customerreminder_model extends CI_Model
{
    var $table = 'tblcustomerreminders';
    var $aid = 'remindernr';
    ...
    {    
        ...
        if($id>0){            
            //Add ID Prefix
            $dataId = array();
            $dataId['remindernr_prefix'] = idprefix('customerreminder',$id);
            ...
            logActivity('New Customer Reminder Added [ID: ' . $id . ', Subject: ' . $name . ']');         
        }
    ...
    {    
        ...
        if ($this->db->affected_rows() > 0) {            
            ...
            //Log Activity
            $name = isset($rowfield->name)?$rowfield->name:'';
            logActivity('Customer Reminder Updated [ID: ' . $id . ', Subject: ' . $name . ']');
        } 
    ...
    public function delete($id)
    {
        ...
        //Log Activity
		$name = isset($rowfield->name)?$rowfield->name:'';
        logActivity('Customer Reminder Deleted [ID: ' . $id . ', Subject: ' . $name . ']');
