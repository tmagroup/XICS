...
function time_ago($time_ago)
{
    ...
    elseif ($minutes <= 60) {
        if ($minutes == 1) {
            ...
            return sprintf(lang('time_ago_minutes'),$minutes);
        }
    }
    //Hours
    elseif ($hours <= 24) {
        if ($hours == 1) {
            ...
            return sprintf(lang('time_ago_hours'),$hours);
        }
    }
    //Days
    elseif ($days <= 7) {
        if ($days == 1) {
            ...
            return sprintf(lang('time_ago_days'),$days);
        }
    }
    //Weeks
    elseif ($weeks <= 4.3) {
        if ($weeks == 1) {
            ...
            return sprintf(lang('time_ago_weeks'),$weeks);
        }
    }
    //Months
    elseif ($months <= 12) {
        if ($months == 1) {
            ...
            return sprintf(lang('time_ago_months'),$months);
        }
    }
    //Years
    else {
        if ($years == 1) {
            ...
            return sprintf(lang('time_ago_years'),$years);
        }
    }
}
