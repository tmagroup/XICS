...
function get_other_merge_fields()
{
    ...
    $fields['{logo_image_with_url}'] = '<a href="' . base_url() . '" target="_blank"><img src="' . base_url('uploads/company/' . get_option('company_logo')) . '"'.($logo_width != '' ? ' width="'.$logo_width.'"' : '').'></a>';

    $fields['{crm_url}']             = site_url();
    //$fields['{admin_url}']           = admin_url();
    $fields['{main_domain}']         = get_option('main_domain');
    $fields['{companyname}']         = get_option('company_name');

    //if (!is_staff_logged_in() || is_client_logged_in()) {

        $fields['{email_signature}'] = get_option('email_signature');
        $fields['{email_signature_invoice}'] = get_option('email_signature_invoice');
...
/**
 * Merge field for monitoring reminder
 * @param  mixed $data array
 * @return array
 */
function get_monitoringreminder_merge_fields($data)
{
    $fields = array();

    $fields['{salutation}'] = $data['salutation'];
    $fields['{user_firstname}'] = $data['name'];
    $fields['{user_lastname}'] = $data['surname'];

    $fields['{monitoringtitle}'] = $data['monitoringtitle'];
    $fields['{monitoringnr}'] = $data['monitoringnr_prefix'];
    $fields['{monitoringcompany}'] = $data['company'];
    $fields['{comments}'] = $data['comments'];
    $fields['{linktomonitoring}'] = $data['linktomonitoring'];

    $hook_data['merge_fields'] = $fields;
    $hook_data['fields_to']    = 'monitoringreminder';
    $hook_data['id']           = $data['monitoringnr'];

    $hook_data = do_action('monitoringreminder_merge_fields', $hook_data);
    $fields    = $hook_data['merge_fields'];
...
/**
 * Merge field for employee commission slip
 * @param  mixed $data array
 * @return array
 */
function get_employeecommissionslip_merge_fields($data)
{
    $fields = array();

    $fields['{user_firstname}']   = $data['name'];
    $fields['{user_lastname}']    = $data['surname'];
    $fields['{slipnr}']           = $data['slipnr_prefix'];
    $fields['{month-year}']       = $data['period'];

    $hook_data['merge_fields'] = $fields;
    $hook_data['fields_to']    = 'employeecommissionslip';
    $hook_data['id']           = $data['slipnr'];

    $hook_data = do_action('employeecommissionslip_merge_fields', $hook_data);
    $fields    = $hook_data['merge_fields'];
...
/**
 * Merge field for lead reminder
 * @param  mixed $data array
 * @return array
 */
function get_leadreminder_merge_fields($data)
{
    $fields = array();
    ...
    $fields['{user_firstname}'] = $data['name'];
    $fields['{user_lastname}'] = $data['surname'];
    $fields['{remindersubject}'] = $data['remindersubject'];
    $fields['{leadnr}'] = $data['leadnr_prefix'];
    $fields['{leadcompany}'] = $data['company'];
    $fields['{remindernotice}'] = $data['notice'];
    $fields['{linktoreminder}'] = $data['linktoreminder'];

    $hook_data['merge_fields'] = $fields;
    $hook_data['fields_to']    = 'leadreminder';
    $hook_data['id']           = $data['leadnr'];

    $hook_data = do_action('leadreminder_merge_fields', $hook_data);
    $fields    = $hook_data['merge_fields'];
 ...
 * @return array
 */
function get_customerreminder_merge_fields($data)
{
    $fields = array();
    ...
    $fields['{user_lastname}'] = $data['surname'];
    $fields['{remindersubject}'] = $data['remindersubject'];
    $fields['{customernr}'] = $data['customernr_prefix'];
    $fields['{customercompany}'] = $data['company'];
    $fields['{remindernotice}'] = $data['notice'];
    $fields['{linktoreminder}'] = $data['linktoreminder'];
    ...
    $hook_data = do_action('customerreminder_merge_fields', $hook_data);
    $fields    = $hook_data['merge_fields'];
 ...
 * @return array
 */
function get_customerreminder_merge_fields2($data)
{
    $fields = array();

    $fields['{salutation}'] = $data['c_salutation'];
    $fields['{user_firstname}'] = $data['c_name'];
    $fields['{user_lastname}'] = $data['c_surname'];
    $fields['{remindersubject}'] = $data['remindersubject'];
    $fields['{customernr}'] = $data['customernr_prefix'];
    $fields['{customercompany}'] = $data['company'];
    $fields['{remindernotice}'] = $data['notice'];
...
/**
 * Merge field for todo reminder
 * @param  mixed $data array
 * @return array
 */
function get_todoreminder_merge_fields($data)
{
    $fields = array();
    ...
    $fields['{todotitle}'] = $data['todotitle'];
    $fields['{startdate}'] = _d($data['startdate']);
    $fields['{todonr}'] = $data['todonr_prefix'];
    // $fields['{todocompany}'] = $data['company'];
    $fields['{todocompany}'] = $data['todocompany'];
    $fields['{tododesc}'] = $data['tododesc'];
    $fields['{comments}'] = $data['comments'];

    $fields['{linktoreminder}'] = $data['linktoreminder'];

    $hook_data['merge_fields'] = $fields;
    $hook_data['fields_to']    = 'todoreminder';
    $hook_data['id']           = $data['todonr'];

    $hook_data = do_action('todoreminder_merge_fields', $hook_data);
    $fields    = $hook_data['merge_fields'];
...
/**
 * Merge field for quotation reminder
 * @param  mixed $data array
 * @return array
 */
function get_quotationreminder_merge_fields($data)
{
    $fields = array();
    ...
    $fields['{user_lastname}'] = $data['surname'];
    $fields['{remindersubject}'] = $data['remindersubject'];
    $fields['{quotationnr}'] = $data['quotationnr_prefix'];
    $fields['{reminddate}'] = _dt($data['reminddate']);
    $fields['{quotationcompany}'] = $data['company'];
    $fields['{remindernotice}'] = $data['notice'];
    $fields['{linktoreminder}'] = $data['linktoreminder'];

    $hook_data['merge_fields'] = $fields;
    $hook_data['fields_to']    = 'quotationreminder';
    $hook_data['id']           = $data['quotationnr'];

    $hook_data = do_action('quotationreminder_merge_fields', $hook_data);
    $fields    = $hook_data['merge_fields'];
 ...
 * @return array
 */
function get_quotationreminder_quotation_merge_fields($data)
{
    $fields = array();
    ...
    $fields['{quotationnr}'] = $data['quotationnr_prefix'];
    $fields['{quotationcompany}'] = $data['company'];
    $fields['{linktoquotation}'] = $data['linktoquotation'];

    $hook_data['merge_fields'] = $fields;
    $hook_data['fields_to']    = 'quotationreminder_quotation';
    $hook_data['id']           = $data['quotationnr'];

    $hook_data = do_action('quotationreminder_quotation_merge_fields', $hook_data);
    $fields    = $hook_data['merge_fields'];
...
/**
 * Merge field for assignment reminder
 * @param  mixed $data array
 * @return array
 */
function get_assignmentreminder_merge_fields($data)
{
    $fields = array();
    ...
    $fields['{user_lastname}'] = $data['surname'];
    $fields['{remindersubject}'] = $data['remindersubject'];
    $fields['{assignmentnr}'] = $data['assignmentnr_prefix'];
    $fields['{reminddate}'] = _dt($data['reminddate']);
    $fields['{assignmentcompany}'] = $data['company'];
    $fields['{remindernotice}'] = $data['notice'];
    $fields['{linktoreminder}'] = $data['linktoreminder'];

    $hook_data['merge_fields'] = $fields;
    $hook_data['fields_to']    = 'assignmentreminder';
    $hook_data['id']           = $data['assignmentnr'];

    $hook_data = do_action('assignmentreminder_merge_fields', $hook_data);
    $fields    = $hook_data['merge_fields'];
 ...
 * @return array
 */
function get_assignmentreminder_assignment_merge_fields($data)
{
    $fields = array();
    ...
    $fields['{assignmentnr}'] = $data['assignmentnr_prefix'];
    $fields['{assignmentcompany}'] = $data['company'];
    $fields['{assignmentproducts}'] = $data['assignmentproducts'];
    $fields['{linktoassignment}'] = $data['linktoassignment'];
...
/**
 * Merge field for ticket reminder
 * @param  mixed $data array
 * @return array
 */
function get_ticketreminder_merge_fields($data)
{
    $fields = array();
    ...
    $fields['{tickettitle}'] = $data['tickettitle'];
    $fields['{ticketnr}'] = $data['ticketnr_prefix'];
    $fields['{ticketcompany}'] = $data['customer_company'];
    $fields['{ticketdesc}'] = $data['ticketdesc'];
    $fields['{comments}'] = $data['comments'];
    $fields['{linktoticket}'] = $data['linktoticket'];

    $hook_data['merge_fields'] = $fields;
    $hook_data['fields_to']    = 'ticketreminder';
    $hook_data['id']           = $data['ticketnr'];

    $hook_data = do_action('ticketreminder_merge_fields', $hook_data);
    $fields    = $hook_data['merge_fields'];
...
/**
 * Merge field for hardware assignment reminder
 * @param  mixed $data array
 * @return array
 */
function get_hardwareassignmentreminder_merge_fields($data)
{
    $fields = array();
    ...
    $fields['{user_lastname}'] = $data['surname'];
    $fields['{remindersubject}'] = $data['remindersubject'];
    $fields['{hardwareassignmentnr}'] = $data['hardwareassignmentnr_prefix'];
    $fields['{reminddate}'] = _dt($data['reminddate']);
    $fields['{hardwareassignmentcompany}'] = $data['company'];
    $fields['{remindernotice}'] = $data['notice'];
    $fields['{linktoreminder}'] = $data['linktoreminder'];

    $hook_data['merge_fields'] = $fields;
    $hook_data['fields_to']    = 'assignmentreminder';
    $hook_data['id']           = $data['hardwareassignmentnr'];

    $hook_data = do_action('hardwareassignmentreminder_merge_fields', $hook_data);
    $fields    = $hook_data['merge_fields'];
 ...
 * @return array
 */
function get_hardwareinvoice_merge_fields($data)
{
    $fields = array();

    $fields['{salutation}'] = $data['salutation'];
    $fields['{user_firstname}'] = $data['customer_name'];
    $fields['{user_lastname}'] = $data['customer_surname'];
    $fields['{hardwareinvoicenr}'] = $data['invoicenr_prefix'];

    $hook_data['merge_fields'] = $fields;
    $hook_data['fields_to']    = 'invoicenr';
    $hook_data['id']           = $data['invoicenr'];

    $hook_data = do_action('hardwareinvoicereminder_merge_fields', $hook_data);
    $fields    = $hook_data['merge_fields'];
